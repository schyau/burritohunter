package com.potato.burritohunter.preference;
...
public class SearchLimitSeekBarPreference extends Preference implements OnSeekBarChangeListener
{
  ...
  public SearchLimitSeekBarPreference( Context context )
  {
    super( context );
  }

  public SearchLimitSeekBarPreference( Context context, AttributeSet attrs )
  {
    super( context, attrs );
  }

  public SearchLimitSeekBarPreference( Context context, AttributeSet attrs, int defStyle )
  {
