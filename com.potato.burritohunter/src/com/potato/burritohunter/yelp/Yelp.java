...
Log.d("url",    request.getUrl());
  ...
  public static void main(String[] args) {
    ...
    String consumerKey = "6kyz0ea-FkU64Uuey69vvw";
    String consumerSecret = "NeK7qa8Tks0O3Jt375TUqu2blDg";
    String token = "aNJYYxdIGYUwiX4loyw7DpAUyWD4vBua";
    String tokenSecret = "kUHZtmODz1hB8ZKJsJ0775Lcd0A";
